<form action="add-usuario.php" method="POST">
    <div class="container-inscricao">
        ...
        <div class="inscricao">
            ...
            <input name="telefone" class="inscricao-telefone" type="text" placeholder="Telefone">
            <input  name="linkedin" class="inscricao-linkedin" type="text" placeholder="Linkedin">
        </div>
...
.inscricao-nome, .inscricao-email, .inscricao-senha, .inscricao-telefone, .inscricao-linkedin {
    margin: 10px;
    border-radius: 6px;
    width: 20rem;
}
